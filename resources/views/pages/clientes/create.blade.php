        ...
        <div class="card shadow-sm border-0">
            <div class="card-body p-4 p-md-5">
                ...
                <form action="{{ route('dashboard.clientes.store') }}" method="POST">
                    @csrf
                    <input type="hidden" name="id" id="id" value="{{ old('id', $cliente->cl_id ?? null) }}">

                    <h6 class="fw-bold text-primary mb-4 text-uppercase" style="font-size: 0.8rem; letter-spacing: 1px;">
                        <i class="fa-regular fa-id-card me-2"></i>Informações Pessoais
                    </h6>

                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            <label class="form-label text-dark fw-medium">Nome Completo <span class="text-danger">*</span></label>
                            <input type="text" name="cl_nome" class="form-control"
                                   value="{{ old('cl_nome', $cliente->cl_nome ?? '') }}"
                                   placeholder="Ex: João da Silva" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label text-dark fw-medium">Usuário (Nick) <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0 text-muted">@</span>
                                <input type="text" name="cl_username" class="form-control border-start-0 ps-0"
                                       value="{{ old('cl_username', $cliente->cl_username ?? '') }}"
                    ...
                    <h6 class="fw-bold text-primary mb-4 text-uppercase" style="font-size: 0.8rem; letter-spacing: 1px;">
                        <i class="fa-solid fa-address-book me-2"></i>Contato & Comunicação
                    </h6>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="cl_email" class="form-control border-start-0 ps-0"
                                       value="{{ old('cl_email', $cliente->cl_email ?? '') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0 text-muted"><i class="fa-regular fa-paper-plane"></i></span>
                                <input type="email" name="cl_email_envio" class="form-control border-start-0 ps-0"
                                       value="{{ old('cl_email_envio', $cliente->cl_email_envio ?? '') }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="cl_cel" class="form-control border-start-0 ps-0"
                                       value="{{ old('cl_cel', $cliente->cl_cel ?? '') }}"
                    ...
                    <hr class="text-muted opacity-10 my-4">
                    <h6 class="fw-bold text-primary mb-4 text-uppercase" style="font-size: 0.8rem; letter-spacing: 1px;">
                        <i class="fa-solid fa-sliders me-2"></i>Status & Detalhes
                    </h6>

                    <div class="row g-4 mb-4">
                        <div class="col-md-12">
                            <label class="form-label text-dark fw-medium">Observações</label>
                            <textarea name="cl_obs" class="form-control" rows="4"
                                      placeholder="Adicione notas, preferências ou histórico rápido do cliente aqui...">{{ old('cl_obs', $cliente->cl_obs ?? '') }}</textarea>
                        </div>
                        <div class="col-md-12">
                            <div class="card bg-danger bg-opacity-10 border-danger border-opacity-25 shadow-none mt-2">
                                <div class="card-body p-3 d-flex align-items-center justify-content-between">
                                    <div>
                                        <h6 class="text-danger fw-bold mb-1"><i class="fa-solid fa-ban me-2"></i>Status: Banido?</h6>
                                        <p class="text-danger opacity-75 small mb-0">
                                            Ao marcar como banido, o cliente perde acesso a todos os serviços contratados e não recebe novos emails do sistema.
                                        </p>
                                    </div>
                                    <div class="form-check form-switch fs-4 mb-0">
                                        <input class="form-check-input border-danger" type="checkbox" role="switch" id="cl_banido" name="cl_banido" value="1"
                                            {{ old('cl_banido', $cliente->cl_banido ?? false) ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end gap-3 mt-5 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary fw-medium px-5 shadow-sm">
