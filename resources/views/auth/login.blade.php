    ...
    <div class="auth-wrapper position-relative overflow-hidden">
        ...
        <div class="card auth-card position-relative z-1">
            <div class="auth-header pb-2">
                <div class="mb-4 d-inline-flex align-items-center justify-content-center bg-primary bg-opacity-10 text-primary rounded-circle"
                ...
                <form class="auth-form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="email" class="form-control" name="email" id="email" placeholder="admin@contasvip.com.br"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <button class="btn btn-outline-light border border-start-0 text-muted bg-light"
                    ...
                    <div class="form-check mb-4">
                        <input class="form-check-input border-primary border-opacity-50" type="checkbox" name="remember"
                    ...
                    <button type="submit" class="btn btn-primary btn-lg w-100 mb-3 shadow-lg">Entrar no Sistema <i
